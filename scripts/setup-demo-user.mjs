...
const DEMO_SEEDS = [
  {
    name: "Emma Hot Lead",
    phone: "+34600000010",
    message: "Hi, I want to book a premium treatment this week.",
    hoursAgo: 26,
    status: "no_response",
    leadType: "Premium treatment",
    estimatedValue: 300,
    priority: "high",
  },
  {
  ...
  },
  {
    ...
    phone: "+34600000012",
    message: "I asked yesterday, any update?",
    hoursAgo: 28,
    status: "no_response",
    leadType: "Follow-up update",
    estimatedValue: 120,
    priority: "high",
  },
  {
    ...
    phone: "+34600000013",
    message: "Do you have availability tomorrow for a premium treatment?",
    hoursAgo: 6,
    status: "active",
    replyOffsetHours: 2,
  ...
  },
  {
    ...
    phone: "+34600000014",
    message: "I want to confirm the premium treatment booking for Friday.",
    hoursAgo: 24,
    status: "won",
    replyOffsetHours: 20,
  ...
  for (const seed of DEMO_SEEDS) {
    ...
    if (outboundAt) {
      messages.push({
        ...
        sender_type: "agent",
        channel: "whatsapp",
        text: seed.replyText ?? "Thanks, I can help you with the next step.",
        raw_payload: { source: "demo_seed" },
