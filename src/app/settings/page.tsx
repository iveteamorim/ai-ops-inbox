...
function getSetupCopy(lang: string) {
  if (lang === "es") {
    return {
      ...
      pilotFeedbackHelp: "Comparte bugs, fricción o ideas de mejora directamente desde el producto.",
  ...
  if (lang === "pt") {
    return {
      ...
      pilotFeedbackTitle: "Reportar problema",
      pilotFeedbackHelp: "Partilhe bugs, fricção ou ideias de melhoria diretamente no produto.",
      pilotFeedbackCategory: "Tipo",
  ...
  return {
    ...
    pilotFeedbackHelp: "Share bugs, friction, or product improvement ideas directly from the app.",
